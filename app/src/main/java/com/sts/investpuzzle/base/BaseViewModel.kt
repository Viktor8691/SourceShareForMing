...
import com.sts.investpuzzle.core.data.network.model.accessories.AccessoryData
...
open class BaseViewModel<I : BaseInteractor> constructor(
    ...
    protected fun <T> callInteractor(interactorSingleMethod : Single<T>, errorHandlerCaller: ErrorHandlerCaller = ErrorHandlerCaller.NONE,
